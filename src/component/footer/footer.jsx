  ...
  return (
    <div className="bg-white  block  w-full   h-auto flex-wrap py-5 flex-col text-blue-600  text-sm font-bold  ">
      ...
      <div className="contact-container flex h-auto py-4 text-gray-900 text-sm font-normal  flex-col lg:flex-row">
        ...
        <div className="Customer-service py-4  lg:w-[20%]">
          <div className="flex-col pl-5 lg:w-[80%] lg:mx-auto">
            <h1 className="text-xl  font-semibold pb-4">Customer Service</h1>
        ...
        <div className="My-account py-4  lg:w-[20%]">
          <div className="flex-col pl-5 lg:w-[80%] lg:mx-auto">
            <h1 className="text-xl font-semibold pb-4">My Account</h1>
            <ul className="space-y-2">
        ...
        <div className="Follow_us flex-col py-4 lg:w-[20%]">
          <div className="flex-col pl-5 lg:w-[80%] lg:mx-auto">
            <h1 className="text-xl font-semibold pb-4">Follow Us</h1>
            <ul className="space-y-2">
              ...
              <li className="">
                <svg
                  ...
                  height="24"
                  fill="currentColor"
                  className=" text-pink-500 transition-colors size-5 inline-block"
                  viewBox="0 0 24 24"
                >
              ...
              <li>
                <svg
                  ...
                  className="lucide lucide-facebook-icon lucide-facebook size-5 inline-block text-blue-600"
                >
              ...
              <li>
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-twitter-icon lucide-twitter inline-block text-blue-500 size-5"
                >
              ...
              <li>
                <img src="src/google-play.webp" className="w-32" alt="" />
              </li>
              <li>
                <img src="src/app-store.webp" className="w-32" alt="" />
              </li>
            </ul>
          </div>
        </div>
        <div className="Contact_us py-4 lg:w-[30%]">
          <div className="flex-col lg:w-[80%] pl-5 lg:mx-auto ">
