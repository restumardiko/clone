...
export default function SingleBookInside() {
  ...
  return (
    <div id="background" className="pt-40 ">
      <div id="book_container" className="w-[85%] bg-white mx-auto flex  mt-20">
        <div className=" w-[30%] ">
          <img className="w-96 mx-auto" src={book.cover} alt="" />
        </div>
        <div className="w-[45%]">
          ...
          <h1 className="text-2xl font-semibold">{book.year}</h1>
          <h2 className="text-2xl font-semibold text-gray-600">In Stock</h2>
        </div>

        <div className="shipping w-[25%] flex flex-col justify-between ">
          <div className="m-2 rounded-md bg-slate-200 ">
            <div className=" flex flex-row m-4">
              <div className="plane w-10 "></div>
              <div className="m-4 ">
                <h1 className="text-3xl font-bold">Free Shipping</h1>
                <h3 className="">Terms and Conditions</h3>
              </div>
            </div>
            <div className="deliv block m-4 text-center">
              <h3>Delivered In :</h3>
              <h4>1-3 Business days (Jakarta)</h4>
              <h4>3-7 Business days (Other)</h4>
            </div>
            <div className="m-4 ">
              <div className="w-full px-16 ">
                <button className="rounded-lg bg-blue-500 w-full p-2  text-center text-xl text-white font-semibold my-2">
                  ADD TO CHART
                </button>
              </div>
              <div className="w-full px-16 ">
